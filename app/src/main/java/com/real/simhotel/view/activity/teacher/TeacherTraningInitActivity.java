        ...
        if (mDialog == null) {
            ...
            mDialog = DialogPlus.newDialog(this)
                    ...
                    .setOnClickListener((dialog, view1)-> {
                            ...
                            String location = ((EditText) content.findViewById(R.id.hotel_location_tv)).getText().toString();
                            String minNum = ((EditText) content.findViewById(R.id.hotel_min_num_tv)).getText().toString();
                            String hotelCost = ((EditText) content.findViewById(R.id.hotel_cost_tv)).getText().toString();
                            ...
                            switch (view.getId()) {
                                case R.id.training_create_confirm: {
                                    ...
                                    template.setLocation(Integer.parseInt(location));
                                    template.setRoomLeastNum(Integer.parseInt(minNum));
